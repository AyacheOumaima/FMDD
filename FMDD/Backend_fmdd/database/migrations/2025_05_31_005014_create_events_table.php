...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('events', function (Blueprint $table) {
            ...
            $table->boolean('is_a_venir')->default(false)->nullable();
            $table->date("date_limite_inscription")->nullable(); 
            $table->time("heure_limite_inscription")->nullable(); 
            $table->date('date')->nullable();
            $table->time('heure')->nullable();
            $table->unsignedInteger('nombre_inscrits')->default(0)->nullable();
            $table->integer('limite_de_places')->default(0)->nullable();
