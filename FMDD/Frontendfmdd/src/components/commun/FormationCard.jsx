...
const FormationCard = ({
  ...
  <Card className="h-full flex flex-col">
    <div className="relative h-48 overflow-hidden">
      ...
      />
      <div className="absolute top-0 right-0 bg-yellow-400 text-indigo-700 px-3 py-1 font-semibold">
        {cost}
      </div>
    </div>
    ...
    <CardBody className="flex flex-col flex-grow">
      ...
      <div className="mt-auto">
        <Link to={`/formations/${id}`}>
          <Button variant="accent" isFullWidth rightIcon={<ArrowRight size={16} />}>
            S'inscrire
          </Button>
        </Link>
      </div>
